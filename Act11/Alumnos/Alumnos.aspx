<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Alumnos.aspx.cs" Inherits="Act11.Alumnos.Alumnos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GVAlumnos" runat="server" AutoGenerateColumns="False" DataKeyNames="matricula" DataSourceID="SqlDataSourceAlumnos" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GVAlumnos_SelectedIndexChanged">
