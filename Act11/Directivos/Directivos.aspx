<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Directivos.aspx.cs" Inherits="Act11.Directivos.Directivos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Página Directivos</h1>
    ...
    <asp:GridView ID="GVDirectivos" runat="server" AutoGenerateColumns="False" DataKeyNames="matricula" DataSourceID="SqlDataSourceDirectivos" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GVDirectivos_SelectedIndexChanged">
